...
try:
    from worqer.lib_provider_config import is_zero_cost_provider
except ImportError:
    try:
        from lib_provider_config import is_zero_cost_provider
    except ImportError:
        def is_zero_cost_provider(provider): return False
