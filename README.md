...
The `Qrane` orchestrator runs directly on the host, while the `Qrew` of AI agents runs inside a Docker container.

### 1. Docker
Docker is essential for running the secure `Qage` environment.
