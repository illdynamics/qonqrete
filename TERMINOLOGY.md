...
- **briQ**: A single, atomic step of the plan, generated by the `instruQtor`. The resulting files are named in kebab-case (e.g., `cyqle1_tasq1_briq001_create-web-server.md`).
