...
export declare class QonQreteRunner {
     ...
     */
    buildSecureEnvMap(): Promise<Record<string, string>>;
     ...
     */
    getRootTasqPath(preferredFolder?: vscode.WorkspaceFolder): Promise<string | undefined>;
    /**
     * Get the internal worqspace tasq path (.qonqrete/worqspace/tasq.md)
     */
    getInternalTasqPath(preferredFolder?: vscode.WorkspaceFolder): Promise<string | undefined>;
    /**
     * Check if .qonqrete runtime is deployed in the workspace
     */
    isDeployed(preferredFolder?: vscode.WorkspaceFolder): Promise<boolean>;
    /**
     * Sync workspace-root tasq.md into internal .qonqrete/worqspace/tasq.md before run
     */
    syncRootTasqToInternal(preferredFolder?: vscode.WorkspaceFolder): Promise<boolean>;
    /**
     * Ensure .qonqrete/ is in .gitignore
     */
    ensureGitignore(preferredFolder?: vscode.WorkspaceFolder): Promise<void>;
