...
class RunTasqAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (service.getQonQretePath() == null) {
            ...
            when (choice) {
                0 -> com.intellij.openapi.actionSystem.ActionManager.getInstance().getAction("QonQrete.DeployToWorkspace")?.actionPerformed(e)
        ...
        if (!service.hasTasqFile()) {
            ...
            if (choice == 0) {
                com.intellij.openapi.actionSystem.ActionManager.getInstance().getAction("QonQrete.CreateTasq")?.actionPerformed(e)
            }
            return
        }
