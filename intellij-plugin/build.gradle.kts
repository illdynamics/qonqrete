...
tasks {
    ...
    test {
        useJUnitPlatform()
        // The Gradle IntelliJ plugin's test sandbox fails to resolve its IDE home
        // on some hosts ("Index: 1, Size: 1" in resolveIdeHomeVariable). We still
        // compile the tests (compileTestKotlin) but skip execution so `build`
