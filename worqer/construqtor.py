...
# v0.8.9 - Improved Code Block Parsing + Empty File Handling
# ═══════════════════════════════════════════════════════════════════════════════
#
# NEW IN v0.8.9:
...
Generated by ConstruQtor v0.8.9 (Interleaved Pipeline)
...
def main():
    ...
    print(f"--- ConstruQtor v0.8.9: Processing {len(briq_files)} Briqs (Interleaved) ---", flush=True)
    ...
    summary_content = f"# Execution Summary (ConstruQtor v0.8.9 - Interleaved Pipeline)\n\n"
    ...
    print(f"\n--- ConstruQtor v0.8.9 Complete: {final_status} ---", flush=True)
