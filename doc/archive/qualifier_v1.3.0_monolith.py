#!/usr/bin/env python3
# Qualifier - Deterministic Post-Cycle Validation
#
...
def run_verification(
    ...
    print(f"[Qualifier] Verifying {len(python_files)} Python files...", flush=True)
    ...
    print(f"[Qualifier] Verification complete: {report.overall_status}", flush=True)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: qualifier.py <qodeyard_path> [qontext_path] [output_path]", flush=True)
        sys.exit(1)
